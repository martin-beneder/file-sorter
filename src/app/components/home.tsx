...
export default function Home() {
  return (
    <div className="items-start flex flex-col" >
      ...
      <div className="justify-center items-center self-stretch flex w-full flex-col mt-4 px-16 sm:px-0 max-md:max-w-full max-md:px-5">
            ...
            <div className="flex flex-col items-stretch w-[34%] max-md:w-full max-md:ml-0">
              <div className="items-center shadow-sm bg-white flex grow flex-col w-full px-4 py-6 rounded-lg max-md:mt-10">
                <Image
                  ...
                  width={87} height={75}
                />
                <div className="self-stretch text-neutral-600 text-center text-3xl sm:text-2xl font-bold leading-9 mt-4">
            ...
            <div className="flex flex-col items-stretch w-[34%] ml-5 max-md:w-full max-md:ml-0">
              <div className="items-center shadow-sm bg-white flex flex-col w-full my-auto px-4 py-6 rounded-lg max-md:mt-10">
                <Image
                  ...
                  width={87} height={75}
                />
                <div className="self-stretch text-neutral-600 text-center sm:text-2xl text-3xl font-bold leading-9 whitespace-nowrap mt-4">
                  Intelligente Suche
                </div>
                <div className="text-neutral-500 text-center text-sm leading-5 self-stretch mt-2">
              ...
              <div className="items-stretch shadow-sm bg-white flex grow flex-col w-full px-4 py-6 rounded-lg max-md:mt-10">
                <div className="items-center flex flex-col px-5">
                  <Image
                    ...
                    width={87} height={75}
                  />
                  <div className="text-neutral-600 text-wrap text-center text-2xl sm:text-2xl font-bold leading-9 self-stretch mt-4">
